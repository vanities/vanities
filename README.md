...
- 📿 on-device-ai bible app with curated devotionals — [swiftbible](https://apps.apple.com/us/app/bible-kjv-swiftbible/id6670373108) (⭐10)
...
- [GPU-Passthrough-Arch-Linux-to-Windows10](https://github.com/vanities/GPU-Passthrough-Arch-Linux-to-Windows10) — gpu passthrough + virt-manager walkthrough (⭐265)
- [PolarisBiosEditor-1.6.7](https://github.com/vanities/PolarisBiosEditor-1.6.7) — amd gpu polaris bios editor (⭐8)
- [lsi-9300-8i-firmware](https://github.com/vanities/lsi-9300-8i-firmware) — lsi sas9300-8i firmware + flash guide
...
- [nextjs-redux-rtkquery-template](https://github.com/vanities/nextjs-redux-rtkquery-template) — nextjs + redux + rtk-query template
- [django-rest-template](https://github.com/vanities/django-rest-template) — django-rest workflow template
...
**stack:** typescript · swift · python · whatever the problem needs
**also:** claude code skills · supabase · fly.io · ffmpeg · deepgram · postgres

→ [catwebm.com](https://catwebm.com) · [am2.biz](https://am2.biz) · [x.com/vanities](https://x.com/vanities)
